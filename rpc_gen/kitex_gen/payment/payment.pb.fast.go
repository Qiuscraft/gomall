...
func (x *ChargeReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Amount, offset, err = fastpb.ReadUint64(buf, _type)
	return offset, err
}
...
func (x *ChargeReq) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint64(buf[offset:], 1, x.GetAmount())
	return offset
}
...
func (x *ChargeResp) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetPayUrl())
	return offset
}
...
func (x *ChargeReq) sizeField1() (n int) {
	...
	n += fastpb.SizeUint64(1, x.GetAmount())
	return n
}
...
func (x *ChargeResp) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetPayUrl())
	return n
}
